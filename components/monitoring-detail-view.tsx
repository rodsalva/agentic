...
const MONITORING_REPLIES = [
  "Com base nas atualizações recentes, o CARF e o STJ convergem para vedação à amortização de ágio interno. Vale revisar operações com estrutura societária semelhante antes do encerramento do exercício.",
  "O propósito negocial genuíno é o elemento central. Documentar a racionalidade econômica de cada etapa é essencial para reduzir o risco de autuação.",
    ...
    <div className="flex-1 flex flex-col h-full bg-white min-w-0">
          ...
          <div className="max-w-xl mx-auto w-full px-6 py-6">
            ...
            {monitoring.items.length === 0 && (
              <div className="flex flex-col items-center gap-3 py-16 text-center">
                ...
                <p className="text-sm text-gray-500">Ainda sem atualizações aqui.</p>
                <p className="text-xs text-gray-400">Quando algo relevante aparecer, te aviso primeiro.</p>
              </div>
            )}
      ...
      {!selectedItem && (
        <div className="flex-shrink-0 max-w-xl mx-auto w-full">
          <AgenticScopedChat
            placeholder={`Pergunte sobre ${monitoring.name}...`}
            replies={MONITORING_REPLIES}
          />
        </div>
      )}
    </div>
